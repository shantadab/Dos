 ...
 */
 ...
 const { parseUrlCompat } = require("./url-compat");
 ...
 if (process.argv.length < 5){console.log(`Usage: node bomb.js URL TIME REQ_PER_SEC THREADS\nExample: node bomb.js https://www.smk.dev/ 500 8 1`); process.exit();}
 ...
 const parsedTarget = parseUrlCompat(args.target);
